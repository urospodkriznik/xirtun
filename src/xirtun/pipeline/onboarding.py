...
ONBOARDING_SYSTEM = (
    ...
    "short, friendly interview — ONE question at a time — gather: age, sex, height, "
    "weight, and typical activity level; food allergies and intolerances; medical "
    ...
    "the user didn't say). Keep it factual; do not invent details. Respond using "
    "the provided schema."
)
